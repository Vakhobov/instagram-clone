...
class User(AbstractUser, BaseModel):
    ...
    def create_verify_code(self, verified_type):
...
class UserConfirmation(BaseModel):
    ...
    verified_type = models.CharField(max_length=31, choices=TYPE_CHOICE)
    user = models.ForeignKey('users.User', models.CASCADE, related_name='verify_codes') #AUTH_USER_MODEL = 'users.User'
    ...
    def save(self, *args, **kwargs):
        if self.verified_type == VIA_EMAIL:  #15-fevral 10:32 +5   10:37
