...
from .serializers import UserCreateSerializer, ChangeUserInformatoion, ChangeUserPhotoSerializer, LoginSerializer, \
...
class VerifyAPIView(APIView):
    ...
    def check_verify(user, code):
        ...
        if not verifies.exists():
            data = {
                "message": "Tasdiqlash Kodingiz noto'g'ri yoki eskirgan!"
            }
...
class GetNewVerification(APIView):
    ...
    def check_verification(user):
        ...
        if verifies.exists():
            data = {
                "message" : "Kodingiz hali ishlatish uchun yaroqli,  please wait...",
            }
            raise ValidationError(data)
...
class ChangeUserInformationView(UpdateAPIView):
    permission_classes = [IsAuthenticated,]
    serializer_class = ChangeUserInformatoion
...
class ChangeUserPhotoView(APIView):
    ...
    def put(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            return Response({
                "message":"Rasm muaffaqiyatli o'zgartirildi"
            }, status=200)
        return Response(
...
class ForgotPasswordView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return Response(
            {
                "success":True,
                "message":"Tasdiqlash kodingiz muvaffaqiyatli yuborldi",
                "access": user.token()['access'],
                "refresh": user.token()['refresh'],
